...
import static com.androidcourse.toktik.utils.Utils.getOutputMediaFile;
import static com.androidcourse.toktik.utils.Utils.getOutputMediaFile;
import static com.androidcourse.toktik.utils.Utils.MEDIA_TYPE_VIDEO;
public class CustomCameraActivity extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    private ImageView record, close, fask, camera_trans;//button
    ...
    private String TAB = "Camera-custom";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_record).setOnClickListener(v -> {
            ...
            if (isRecording == 1) {
                ...
                isRecording = 2;
                timer.stop();
                record.setImageResource(R.drawable.next);
                ...
                isRecording = 1;
                record.setImageResource(R.drawable.radiobuttonselect);
            }
    ...
    private boolean prepareVideoRecorder() {
        ...
        Log.d(TAB,"start creating");
        mMediaRecorder = new MediaRecorder();
        Log.d(TAB,"start creating"+mMediaRecorder);
        mCamera.unlock();
